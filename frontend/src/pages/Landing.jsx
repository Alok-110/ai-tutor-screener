...
const IllustrationSVG = () => (
  <svg viewBox="0 0 520 580" xmlns="http://www.w3.org/2000/svg" style={{width:'100%',height:'100%',display:'block'}}>
    {/* Background blobs */}
    ...
    {/* Screen content */}
    <rect x="172" y="226" width="80" height="8" rx="4" fill="rgba(255,255,255,0.15)"/>
    <rect x="172" y="240" width="120" height="6" rx="3" fill="rgba(255,255,255,0.08)"/>
    <rect x="172" y="252" width="100" height="6" rx="3" fill="rgba(255,255,255,0.08)"/>
    {/* Waveform on screen */}
    ...
    {/* Headphones */}
    <path d="M228 185 Q228 155 260 155 Q292 155 292 185" fill="none" stroke="#4F46E5" strokeWidth="6" strokeLinecap="round"/>
    ...
    <path d="M253 197 Q260 203 267 197" fill="none" stroke="#1E293B" strokeWidth="2" strokeLinecap="round"/>
    {/* Shoulders */}
    ...
    <rect x="30" y="130" width="150" height="52" rx="14" fill="none" stroke="#E0E7FF" strokeWidth="1.5"/>
    ...
    <text x="58" y="146" textAnchor="middle" fill="#fff" fontSize="8" fontWeight="700" fontFamily="sans-serif">AI</text>
    ...
    <rect x="354" y="244" width="80" height="7" rx="3.5" fill="rgba(255,255,255,0.4)"/>
    <rect x="354" y="257" width="60" height="7" rx="3.5" fill="rgba(255,255,255,0.25)"/>

    {/* Floating score badge */}
    <rect x="360" y="130" width="120" height="72" rx="14" fill="#fff"/>
    <rect x="360" y="130" width="120" height="72" rx="14" fill="none" stroke="#E0E7FF" strokeWidth="1.5"/>
    <text x="375" y="148" fill="#6366F1" fontSize="8" fontWeight="700" fontFamily="sans-serif">SCORE</text>
    {/* bars */}
    ...
    <text x="419" y="194" textAnchor="middle" fill="#065F46" fontSize="7" fontWeight="700" fontFamily="sans-serif">Strong Yes ✓</text>

    {/* Floating mic icon */}
    <circle cx="76" cy="300" r="24" fill="#FEF3C7"/>
    <rect x="70" y="286" width="12" height="20" rx="6" fill="#F59E0B"/>
    <path d="M64 302 Q64 314 76 314 Q88 314 88 302" fill="none" stroke="#F59E0B" strokeWidth="2.5" strokeLinecap="round"/>
      ...
      <div className="land">
        ...
        <div className="hero">
          ...
          <div className="hero-right">
            ...
            <p style={{fontSize:16,color:'#6b7280',lineHeight:1.75,maxWidth:400,margin:0}}>
