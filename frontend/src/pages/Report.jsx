...
export default function Report() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${import.meta.env.VITE_API_URL}/api/admin/candidates/${id}`)
      .then((r) => {
        setCandidate(r.data);
        setLoading(false);
      })
  ...
  const avg = (
    dims.reduce((s, k) => s + (a?.[k] || 0), 0) / dims.length
  ).toFixed(1);
                  ...
                  <div style={{ flex: 1 }}>
                    <div
                      style={{
                        fontSize: 11,
                        fontWeight: 700,
                        color: t.speaker === "ai" ? "#2563eb" : "#10b981",
                        marginBottom: 4,
                        textTransform: "uppercase",
                    ...
                    <div
                      style={{
                        ...
                        color: "#374151",
                        lineHeight: 1.65,
                        background: t.speaker === "ai" ? "#f8fafc" : "#f0fdf4",
                        padding: "12px 16px",
                        borderRadius:
                          t.speaker === "ai"
                            ? "4px 14px 14px 14px"
